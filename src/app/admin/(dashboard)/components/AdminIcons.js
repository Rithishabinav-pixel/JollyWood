...
export function OffersIcon(props) {
  return (
    <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="1.8" {...props}>
      <path d="M20.5 12.5 12.9 20a1.5 1.5 0 0 1-2.12 0l-7.28-7.28a1.5 1.5 0 0 1-.44-1.06V5.5A2 2 0 0 1 5 3.5h6.16c.4 0 .78.16 1.06.44l8.28 8.28a1.5 1.5 0 0 1 0 2.28Z" />
      <circle cx="8" cy="8" r="1.5" />
    </svg>
  );
}

export function StoriesIcon(props) {
  return (
    <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="1.8" {...props}>
...
export function AnnouncementsIcon(props) {
  return (
    <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="1.8" {...props}>
      ...
      <path d="M14 8.5c1 1 1 5.5 0 7.5" />
      <path d="M18 6c2 2.5 2 9.5 0 12" />
    </svg>
  );
}
